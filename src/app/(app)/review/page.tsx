    ...
    <div style={{ maxWidth: 640, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontSize: 12, color: 'var(--muted)' }}>{index + 1} / {cards.length}</span>
        </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
        <span style={{ fontSize: 11, fontWeight: 700, padding: '2px 10px', borderRadius: 99, background: 'var(--accent-subtle)', color: 'var(--accent)' }}>
          Part {q?.part}
        </span>
      ...
      <div className="card" style={{ padding: '24px 28px', marginBottom: 16 }}>
        <p className="text-sm" style={{ lineHeight: 1.7 }}>{getContentText()}</p>
      </div>
      ...
      {submitted && q?.explanation && (
        <div style={{ padding: '14px 18px', borderRadius: 10, background: 'var(--accent-subtle)', border: '1px solid var(--accent)', marginBottom: 16 }}>
          ...
          <p className="text-sm" style={{ lineHeight: 1.6 }}>{q.explanation}</p>
        </div>
      )}
