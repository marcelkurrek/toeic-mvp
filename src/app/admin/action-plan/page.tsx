...
const TASKS: Task[] = [
  ...
  { title: 'Vollprüfungs-Simulation (200 Fragen)', desc: '120 Min echte Prüfung: 45 Min Listening automatisch (kein Skip), dann 75 Min Reading selbstgesteuert. Echter Prüfungsablauf 1:1', status: 'done', priority: 'hoch', category: 'Practice' },
  ...
  { title: 'Spaced Repetition für falsche Fragen', desc: 'Falsch beantwortete Fragen kommen in künftigen Sessions priorisiert zurück. wrong_questions Tracking + "Schwache Fragen üben" Modus. Größter Lernhebel: Kern-Prinzip von Anki/Duolingo.', status: 'done', priority: 'hoch', category: 'Practice' },
  ...
  { title: 'Session Fehler-Review: Nochmal üben', desc: 'Am Ende jeder Session: "Falsche Fragen nochmal üben" Button startet sofort eine neue Session nur mit den falsch beantworteten Fragen. Direktes Wiederholungs-Lernen im Flow.', status: 'done', priority: 'mittel', category: 'Practice' },
  { title: 'Mehr Content: Speaking + Writing Fragen', desc: 'Writing lädt nur 3 Fragen, Speaking ist begrenzt. Content erschöpft sich nach 2-3 Sessions — User sieht Wiederholungen. Seed-Daten massiv ausbauen für Speaking und Writing.', status: 'done', priority: 'hoch', category: 'Infra' },

  // ── Neu aus Practice Test 1 Analyse ──────────────────────────────────────
  { title: 'Distractor-Typ Analyse nach Antwort', desc: 'Nach jeder Frage: für jede falsche Option den Distractor-Typ benennen: "Sound-alike Trap / Related-word Trap / Repeated-word Trap / Context Swap / Partial Truth". Barron\'s Erklärungsformat 1:1 implementieren — nachgewiesener Lerneffekt', status: 'done', priority: 'hoch', category: 'Core' },
