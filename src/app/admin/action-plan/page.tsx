...
const TASKS: Task[] = [
  ...
  { title: 'Listening: Transcript-Toggle pro Frage', desc: 'Nach Beantwortung jeder Listening-Frage: aufklappbares Transkript mit farbmarkierten Schlüsselwörtern. User sieht exakt was gesagt wurde und was er überhörte.', status: 'planned', priority: 'hoch', category: 'Core' },
  { title: 'Listening: Part 3/4 Sub-Question Fortschrittsanzeige', desc: 'Bei Multi-Question-Sets (3 Fragen pro Gespräch) visuell anzeigen welche der 3 Sub-Fragen bereits beantwortet sind. Verhindert Orientierungsverlust.', status: 'planned', priority: 'mittel', category: 'Core' },
  ...
  { title: 'Speaking: Mikrofon-Permission Check', desc: 'Vor erster Aufnahme: getUserMedia testen und klare Anleitung zeigen wenn Permission verweigert. Verhindert stumme Sessions. Mit Browser-spezifischen Anweisungen.', status: 'planned', priority: 'hoch', category: 'Core' },
  { title: 'Speaking: Musterantwort als Referenz', desc: 'Nach KI-Feedback: Musterantwort (text oder audio) zeigen die dem TOEIC-Ideal entspricht. User kann seinen Ansatz damit vergleichen und gezielt verbessern.', status: 'planned', priority: 'hoch', category: 'Core' },
  ...
  { title: 'Writing: Draft-Autosave (localStorage)', desc: 'Text wird alle 10s automatisch in localStorage gespeichert. Beim Reload: "Entwurf gefunden — wiederherstellen?" Banner. Verhindert Datenverlust bei Seitenrefresh.', status: 'planned', priority: 'hoch', category: 'Core' },
  ...
  { title: 'PracticeShell: Frage überspringen', desc: '"Überspringen" Button der die Frage ans Ende der Session schiebt. Am Ende: übersprungene Fragen werden nochmals gestellt. Reduziert Frustration bei schwierigen Fragen.', status: 'planned', priority: 'mittel', category: 'Core' },
  { title: 'Grammar Pattern Fehleranalyse', desc: 'Auf der Progress-Seite: "Du machst verb-form Fragen 3× häufiger falsch als connector Fragen." Basiert auf question.tags + Answer-History. Gibt gezielte Übungsempfehlung.', status: 'planned', priority: 'hoch', category: 'Dashboard' },
  { title: 'Post-Session Debrief Card', desc: 'Nach jeder Session: kleine Zusammenfassung — welche Grammatikmuster falsch, Durchschnittszeit pro Frage, Vergleich zur letzten Session, 1 konkreter Verbesserungstipp.', status: 'planned', priority: 'hoch', category: 'Core' },
  { title: 'Abbruch-Bestätigung bei offener Session', desc: '"Möchtest du wirklich abbrechen? Dein Fortschritt wird nicht gespeichert." Dialog wenn User mitten in einer Session auf Zurück/Link klickt. Verhindert versehentlichen Abbruch.', status: 'planned', priority: 'mittel', category: 'Core' },
  { title: 'Part-Strategie Hints vor Übung', desc: 'Vor jedem Part kurze TOEIC-Strategie-Box zeigen: "Part 3: Lies die Fragen BEVOR das Audio startet. Fokus: Wer, Was, Warum." Echtes Prüfungswissen direkt im Flow.', status: 'planned', priority: 'hoch', category: 'Core' },
