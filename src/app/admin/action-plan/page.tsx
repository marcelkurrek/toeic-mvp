...
const TASKS: Task[] = [
  ...
  { title: 'Listening: Fehler-Typ Tagging', desc: 'Nach falscher Antwort automatisch kategorisieren: "Distractor-Falle" (klingt ähnlich), "Negationswort überhört", "Zeitangabe verwechselt". Lehrt den User seinen blinden Fleck zu erkennen.', status: 'in-progress', priority: 'mittel', category: 'Core' },
  { title: 'Listening: Session-Vokabular', desc: '3–5 Business-Wörter aus den Transkripten der Session am Ende zeigen. Mit Kontext-Satz und DE-Bedeutung. Spaced-Repetition-tauglich weil kontextuell verknüpft.', status: 'in-progress', priority: 'mittel', category: 'Core' },
  ...
  { title: 'Writing: Iterativer Schreib-Prozess', desc: 'Nach Feedback: "Überarbeiten"-Button zeigt denselben Text im Editor mit Feedback sichtbar daneben. User schreibt nochmal, bekommt neues Feedback, sieht die Verbesserung. Echter Revision-Cycle.', status: 'in-progress', priority: 'mittel', category: 'Core' },
  { title: 'Writing: Musterlösung mit Annotation', desc: 'Nach Feedback: annotierte Musterlösung zeigen — Sätze farbmarkiert (grün = Pflichtphrase, blau = gute Struktur, orange = Verbesserungshinweis).', status: 'in-progress', priority: 'mittel', category: 'Core' },
  { title: 'Writing: Essay-Template Guide', desc: 'Interaktive Seite unter /writing mit der TOEIC-Essay-Formel: 4 Paragraphen, Pflichtphrasen pro Abschnitt, Farb-annotiertes Beispiel-Essay. Einmal lernen, dauerhaft anwenden.', status: 'in-progress', priority: 'mittel', category: 'Core' },
  // READING
  ...
  { title: 'Progress: Grammatik-Muster Milestones', desc: '"Du hast alle 15 Part-5-Muster mindestens 5× geübt" Achievement. Markiert echte Lernmeilensteine die systematisches Durcharbeiten belohnen. Verknüpft mit Achievements-System.', status: 'in-progress', priority: 'mittel', category: 'Dashboard' },
