...
const TASKS: Task[] = [
  ...
  { title: 'Listening: Schlüssel-Phrase Highlighting', desc: 'Nach falscher Antwort: exakte Transkript-Zeile die die Antwort enthält farbig hervorgehoben. "by Wednesday" ≠ "on Wednesday" — User sieht exakt was er überhört hat.', status: 'in-progress', priority: 'hoch', category: 'Core' },
  { title: 'Listening: Fehler-Typ Tagging', desc: 'Nach falscher Antwort automatisch kategorisieren: "Distractor-Falle" (klingt ähnlich), "Negationswort überhört", "Zeitangabe verwechselt". Lehrt den User seinen blinden Fleck zu erkennen.', status: 'planned', priority: 'mittel', category: 'Core' },
  { title: 'Listening: Session-Vokabular', desc: '3–5 Business-Wörter aus den Transkripten der Session am Ende zeigen. Mit Kontext-Satz und DE-Bedeutung. Spaced-Repetition-tauglich weil kontextuell verknüpft.', status: 'planned', priority: 'mittel', category: 'Core' },
  ...
  { title: 'Speaking: Musterantwort als Referenz', desc: 'Nach KI-Feedback: Task-spezifische Musterantwort-Struktur zeigen (Text) mit vollständigem Beispielsatz. User vergleicht seinen Ansatz: "ich sagte X, die Norm wäre Y". Konkretes Ziel statt abstraktem Score.', status: 'in-progress', priority: 'hoch', category: 'Core' },
  ...
  { title: 'Writing: Phrase-Baukasten', desc: 'Klappbare Business-Phrasen-Bibliothek vor Email- und Essay-Tasks. Kategorisiert nach Funktion: Eröffnung, Bitte, Beschwerde, Abschluss (Email) / Einleitung, Argument, Beispiel, Schluss (Essay). 40% des TOEIC Writing Scores basiert auf Phrasen-Einsatz.', status: 'in-progress', priority: 'hoch', category: 'Core' },
  { title: 'Writing: Iterativer Schreib-Prozess', desc: 'Nach Feedback: "Überarbeiten"-Button zeigt denselben Text im Editor mit Feedback sichtbar daneben. User schreibt nochmal, bekommt neues Feedback, sieht die Verbesserung. Echter Revision-Cycle.', status: 'planned', priority: 'mittel', category: 'Core' },
  { title: 'Writing: Musterlösung mit Annotation', desc: 'Nach Feedback: annotierte Musterlösung zeigen — Sätze farbmarkiert (grün = Pflichtphrase, blau = gute Struktur, orange = Verbesserungshinweis).', status: 'planned', priority: 'mittel', category: 'Core' },
  { title: 'Writing: Essay-Template Guide', desc: 'Interaktive Seite unter /writing mit der TOEIC-Essay-Formel: 4 Paragraphen, Pflichtphrasen pro Abschnitt, Farb-annotiertes Beispiel-Essay. Einmal lernen, dauerhaft anwenden.', status: 'planned', priority: 'mittel', category: 'Core' },
  // READING
  ...
  { title: 'Reading: Part 7 Frage-Typ Strategie-Hints', desc: 'Pro Frage Typ-Erkennung (NOT/Detail/Inference/Synonym/Purpose) und passende Strategie-Box. "NOT-Frage: suche 3 Optionen die IM Text stehen." Schüler lernen die Technik direkt beim Üben.', status: 'in-progress', priority: 'hoch', category: 'Core' },
  { title: 'Reading: Part 6 Dokumenttyp-Kontext', desc: 'Vor jeder Part-6-Passage: erkannten Dokumenttyp anzeigen (E-Mail/Memo/Bericht/Protokoll) + relevante Grammatik-Regel. "Das ist eine Geschäfts-E-Mail → Present Perfect für abgeschlossene Aktionen."', status: 'in-progress', priority: 'mittel', category: 'Core' },
  { title: 'Reading: Part 5 Muster-Mastery Tracking', desc: 'Progress-Seite zeigt pro Grammatikmuster: X/Y Fragen richtig. "Verb-Form: 8/12 ✓ | Präpositionen: 4/12 — Fokus!" Strukturiertes Durcharbeiten aller 15 TOEIC-Muster wie in einem Lehrbuch.', status: 'in-progress', priority: 'hoch', category: 'Dashboard' },
  // ÜBERGREIFEND
  ...
  { title: 'Progress: Grammatik-Muster Milestones', desc: '"Du hast alle 15 Part-5-Muster mindestens 5× geübt" Achievement. Markiert echte Lernmeilensteine die systematisches Durcharbeiten belohnen. Verknüpft mit Achievements-System.', status: 'planned', priority: 'mittel', category: 'Dashboard' },
  { title: 'TOEIC Score-Conversion Tooltip', desc: 'Neben dem geschätzten Score: kleiner Info-Button der eine Tabelle öffnet: "70% Genauigkeit ≈ 550–600 Punkte". Macht abstrakten Score greifbar und motiviert.', status: 'planned', priority: 'niedrig', category: 'Dashboard' },
