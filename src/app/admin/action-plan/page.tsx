...
const TASKS: Task[] = [
  ...
  { title: 'Speaking: Score in DB persistieren', desc: 'AI-Scores aus Speech-Feedback nach jeder Speaking-Session in der DB speichern (Session + Answer Records). Voraussetzung für Score-Trend-Chart und Fortschritts-Continuität.', status: 'planned', priority: 'hoch', category: 'Core' },
  // WRITING
  ...
  { title: 'Writing: Score in DB persistieren', desc: 'AI-Scores aus Writing-Feedback nach jeder Writing-Session in der DB speichern. Voraussetzung für Score-Trend-Chart. Aktuell gehen alle Writing-Scores nach Session-Ende verloren.', status: 'planned', priority: 'hoch', category: 'Core' },
  { title: 'Writing: Side-by-Side Revision View', desc: 'Beim "Überarbeiten"-Klick: Split-View zeigt links das alte Feedback und rechts den neuen Editor. User schreibt nicht blind — er sieht genau was er verbessern soll.', status: 'planned', priority: 'mittel', category: 'Core' },
  // READING
  ...
  { title: 'Zeitbewusstsein / Speed-Feedback', desc: 'Nach jeder Session anzeigen: "Ø 90 Sek. pro Part-5-Frage — Ziel: 45 Sek." TOEIC ist zeitkritisch. Studenten können 85% Genauigkeit haben aber zu langsam sein für echte Prüfung.', status: 'planned', priority: 'hoch', category: 'Core' },
  { title: 'Part 5 Drill-Modus für schwache Muster', desc: 'Direkter "Nur Präpositions-Fragen üben" Button auf Progress-Seite neben jedem schwachen Grammatikmuster. API-Tag-Filter + dedizierte Drill-Seite /practice/part5/drill?pattern=preposition.', status: 'planned', priority: 'hoch', category: 'Practice' },
